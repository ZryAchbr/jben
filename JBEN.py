...
parser = argparse.ArgumentParser(description='usage : python3 JBEN.py -s <site> -f <file type>')
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠑⢤⣀⣀⣀⣀⣠⠜⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⣉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
      LEAKER TOOLS BY JAWA BARAT EROR NETWORK 
""")
a1 = args.s
filetypes = args.f
try:
    ...
    for files in file_types:
           try: 
                 ...
                 print(info + f'\033[1;33m<!> Processing <!>: Searching Info For {filetypes}..')
                 for results in search(f'site:{a1} filetype:{filetypes}', tld='com', lang='en', num=int(f'{counter}'), start=0, stop=None, pause=10):
               ...
               print(fail + f'[Error] File {filetypes} could not be downloaded. Skipping.')
               continue
    ...
    print("Usage : python3 JBEN.py -s {site} -f {file extension type}")
print ("Done...")
print ("\n\t\t\t\t\033[34mJawa Barat Eror Network\033[0m")
print ("\t\t\033[1;91mExit\n\n")   
exit()
